 ...
 * Class description:
 * (RUS)
 * Класс для работы с матрица. Реализованы самые популярные методы для работы с матрицами,
 * переопределены операторы(+,-,*,/, !(обратная матрица), ~(транспонированная)). Индексатор для доступа к элементам. К сожалению очень медленный
...
namespace csalgs.math.elementary
{
	public class RealMatrix
	{
		...
		{
			if (m == null) throw new ArgumentNullException("m is null");
